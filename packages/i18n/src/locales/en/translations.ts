...
export default {
  ...
  project_settings: {
    ...
    custom_properties: {
      ...
      description: "Define custom fields for each work item type.",
      default_badge: "Default",
      property_count: "{count} properties",
      add_property: "Add property",
      loading: "Loading...",
      no_properties: 'No properties. Click "Add property" to create one.',
      no_issue_types: "No work item types configured for this project.",
      property_name: "Property name",
      property_name_placeholder: "e.g. Priority, Department",
      property_name_required: "Name is required",
      property_type: "Type",
      type_not_changeable: "Type cannot be changed after creation",
      required: "Required",
      active: "Active",
      inactive: "Inactive",
      ...
      type_member: "Member (single)",
      type_multi_member: "Member (multiple)",
    },
    automations: {
      label: "Automations",
      heading: "Automations",

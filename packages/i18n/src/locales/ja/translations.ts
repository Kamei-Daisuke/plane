...
export default {
  ...
  project_settings: {
    ...
    custom_properties: {
      ...
      default_badge: "デフォルト",
      property_count: "{{count}} プロパティ",
      add_property: "プロパティを追加",
      loading: "読み込み中...",
      no_properties: "プロパティがありません。「プロパティを追加」で作成してください。",
      no_issue_types: "このプロジェクトにはワークアイテムタイプが設定されていません。",
      property_name: "プロパティ名",
      property_name_placeholder: "例: 優先度、担当部署",
      property_name_required: "名前は必須です",
      property_type: "型",
      type_not_changeable: "型は作成後に変更できません",
      required: "必須",
      active: "有効",
      inactive: "無効",
      save_failed: "保存に失敗しました",
      option_name_required: "選択肢名は必須です",
      option_placeholder: "選択肢名",
      no_color: "なし",
      options_count: "{{count}} 選択肢",
